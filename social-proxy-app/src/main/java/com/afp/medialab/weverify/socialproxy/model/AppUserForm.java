...
public class AppUserForm {
	...
	public AppUserForm(Connection<?> connection) {
		...
		ConnectionData connnectData = connection.createData();
		this.userId = null;
		...
		this.accessToken = connnectData.getAccessToken();
		this.accessTokenSecret = connnectData.getSecret();
		this.hasExpired = connection.hasExpired();
