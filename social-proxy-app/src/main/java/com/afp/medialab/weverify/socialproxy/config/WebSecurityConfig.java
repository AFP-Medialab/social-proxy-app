...
import com.afp.medialab.weverify.socialproxy.handler.CustomLogout;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().and().logout().logoutUrl("/logout").logoutSuccessHandler(logoutSuccessHandler());
		http.apply(new SpringSocialConfigurer()).signupUrl("/userInfo");
	}
